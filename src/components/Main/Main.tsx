        ...
        options={{
          ...
          particles: {
            ...
            shape: {
              ...
              image: [
                { src: bootstrapIconUrl, width: 20, height: 20 },
                { src: cssIconUrl, width: 20, height: 20 },
                { src: wordpressIconUrl, width: 20, height: 20 },
                { src: shopifyIconUrl, width: 20, height: 20 },
                { src: htmlIconUrl, width: 20, height: 20 },
                { src: jsIconUrl, width: 20, height: 20 },
                { src: nodeIconUrl, width: 20, height: 20 },
                { src: reactIconUrl, width: 20, height: 20 },
                { src: sassIconUrl, width: 20, height: 20 },
                { src: typescriptIconUrl, width: 20, height: 20 },
                { src: vueIconUrl, width: 20, height: 20 },
              ],
              polygon: {
                sides: 5,
              },
