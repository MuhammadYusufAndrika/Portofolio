      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <footer> <ul className="tech-list"> <li>Vue Js</li> <li>Javascript</li> <li>MysqlDB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <footer> <ul className="tech-list"> <li>C#</li> <li>MySqlDB</li> <li></li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <footer> <ul className="tech-list"> <li>C</li> <li></li> <li></li> </ul> </footer>
          </div>
        </ScrollAnimation>
